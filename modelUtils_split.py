...
my_split_points = {
    'resnet50': [1, 2, 3, 4, 5, 6, 12, 17, 18, 27, 28, 37, 38, 49, 50, 59, 60, 69, 70, 79, 80, 91],
    ...
    'DenseNet121': [1, 2, 3, 4, 5, 6, 13, 20, 27, 34, 41, 48, 49, 50, 51, 52, 59, 66, 73, 80, 87, 94, 101, 108, 115, 122, 129, 136, 137, 138, 139, 140, 147, 154, 161, 168, 175, 182, 189, 196, 203, 210, 217],
...
def convert_image_to_tensor(img, input_size):
    ...
    tensor = tf.image.resize(np.array(img_rgb), [input_size, input_size]) 
