...
def get_request_body(left_output, frame_seq_no, split_point):
    # Request JSON.
    request_body = {'client_id': "client_2", 'total_frames_no': frame_seq_no, 'split_point': split_point}
    ...
    for split_point in split_points:
        ...
        while frame_seq_no < frames_to_process + 1:
            ...
            if ret:                 
                ...
                post_data = {'client_id': "client_2",'data':encoded_data, 'shape':list(stack.shape),'frame_seq_no': frame_seq_no, 'split_point': split_point}
...
def log_metrics(split_point, time, single_frame_time, left_output_size, avg_consec_inference_gap, total_left_model_time,total_right_model_time):
    write_to_csv(model_name + '_async2' + '.csv', metrics_headers, [frames_to_process, split_point, time, single_frame_time, left_output_size, avg_consec_inference_gap, total_left_model_time,total_right_model_time])
