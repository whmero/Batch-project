...
async def consumer():
    ...
    async for item in q:
        try:   
            ...
            post_data = {'client_id': "client_3",'data': item[0], 'frame_seq_no': item[1]} # item[0] = out_left, item[1] = frame_seq_no
...
def get_request_body(left_output, frame_seq_no, split_point):
    # Request JSON.
    request_body = {'client_id': "client_3",'data': left_output, 'frame_seq_no': frame_seq_no, 'split_point': split_point}
    return request_body
